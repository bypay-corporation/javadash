...
public class UnionWithTest {
    ...
    void testUnionWithComparator() {
        ...
        assertEquals(new ArrayList<>(List.of(1, 2, 3, 4, 5)), result);  // Should return [1, 2, 3, 4, 5] without duplicates
    }
    ...
    void testUnionWithNullLists() {
        ...
        assertEquals(new ArrayList<>(List.of(1, 2)), result);  // Should return [1, 2]
    }
    ...
    void testUnionWithComparatorForCustomObject() {
        ...
        assertEquals(new ArrayList<>(List.of(new Person("Alice", 30), new Person("Bob", 25), new Person("Charlie", 35))), result);
    }
    ...
    void testUnionWithNullAndEmptyLists() {
        ...
        assertEquals(new ArrayList<>(List.of(3, 4)), result);  // Should return [3, 4] from list2
    }
