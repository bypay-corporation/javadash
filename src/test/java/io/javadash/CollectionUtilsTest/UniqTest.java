...
public class UniqTest {
    ...
    void testUniqWithDuplicates() {
        ...
        assertEquals(new ArrayList<>(List.of(1, 2, 3)), result);  // Should return [1, 2, 3] without duplicates
    }
    ...
    void testUniqWithNoDuplicates() {
        ...
        assertEquals(new ArrayList<>(List.of(1, 2, 3)), result);  // Should return [1, 2, 3]
    }
