...
public class TailTest {
    ...
    void testTailWithNonEmptyList() {
        ...
        assertEquals(new ArrayList<>(List.of("banana", "cherry", "date")), tailList);
    }
    ...
    void testTailWithMultipleIdenticalElements() {
        ...
        assertEquals(new ArrayList<>(List.of("apple", "apple", "apple")), tailList);
    }
    ...
    void testTailWithListOfSizeTwo() {
        ...
        assertEquals(new ArrayList<>(List.of("banana")), tailList);  // Should return a list with the second element
    }
}
