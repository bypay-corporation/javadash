...
public class ConcatTest {
    ...
    public void testConcatWithNullValues() {
        ...
        assertEquals(Arrays.asList(1, null, 2, null, 3), result);
    }
    ...
    public void testConcatWithNullElementInList() {
        ...
        assertEquals(Arrays.asList(1, 2, null, 3), result);
    }
    ...
    public void testConcatWithOnlyNullValues() {
        ...
        assertEquals(Arrays.asList(1, null, null, null), result);
    }
    ...
    public void testConcatWithNullListInMiddle() {
        ...
        assertEquals(Arrays.asList(1, 2, 3, 4, null, 5, 6), result);
    }
}
